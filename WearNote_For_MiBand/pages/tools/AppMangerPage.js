        ...
        onInit(param) {
            try {
                ...
                function SCROLL_LIST_click(index) {
                    hmApp.gotoPage({
                        url: 'pages/tools/AppMangerDelPage',
                ...
                function jzxcxmz(ll, app_path2, paths) {
                    ...
                    try {
                        ...
                        if (ey_json['app']["appId"].toString() == '49897'){
                            if (language == 0 || language == 1) {
                                var ybappname = '环管Pro';
                            } else {
                ...
                function jzxcxlb() {
                    ...
                    //textxg('162')
                    /*var n = [{
                        text: language_shuaxin,
                        name: language_shuaxin,
                        type: 1,
                        path: language_shuaxin
                    }]*/
                    ...
                    if (AppsList == 'notfile' || param == '1' || AppManger_cache == false) {
                        ...
                        if (jideList !== 'notfile'){
                            ...
                            for(var name in jideList){
                                if (jideList[name]["sbqy"] == '1'){
                                    if (jlysmz[jideList[name]["appName"]] == undefined){
                                        n.push({
                                            text: jideList[name]["appName"] + ' (' + language_yc + ')',
                                            name: jideList[name]["appName"] + ' (' + language_yc + ')',
                                            type: 1,
                                            path: jideList[name]["appDelPath"]
                                        });
                                    }
                                }
                            }
